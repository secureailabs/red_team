...
def get_entities(transcript):
    ...
    for entity in doc.ents:
        ...
        elif 'PERSON' in str(entity.label_):
...
with open('questions.txt', 'w') as f:
    print(*patient_questions, sep='; ', file=f)
with open('symptoms.txt', 'w') as f:
    print(*symptoms, sep='; ', file=f)
with open('raw_keywords.txt', 'w') as f:
    print(*raw_keywords, sep='; ', file=f)
with open('dates.txt', 'w') as f:
    print(*dates, sep='; ', file=f)
with open('orgs.txt', 'w') as f:
    print(*orgs, sep='; ', file=f)
with open('names.txt', 'w') as f:
    print(*names, sep='; ', file=f)
with open('verbs.txt', 'w') as f:
    print(*verbs, sep='; ', file=f)
